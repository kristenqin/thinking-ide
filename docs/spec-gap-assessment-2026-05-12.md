...
| GAP-06 | Markdown / answer_outline 仍停留在启发式 checkpoint | 回答结构项应生成 `answer_outline node`，并能定位到回答段落；概念提取应利用标题、段落主题、步骤、观点、结论。见 [thinking_ide_prd_产品需求文档.md](/Users/qyx/Desktop/project/thinking-ide/docs/specs/thinking_ide_prd_产品需求文档.md) | 当前已新增启发式 `answer_outline` 节点和 `contains` 关系；[src/utils/text.ts](/Users/qyx/Desktop/project/thinking-ide/src/utils/text.ts) 现在会优先使用 Markdown H1 heading，再回退到 list / paragraph theme；[src/models/source.ts](/Users/qyx/Desktop/project/thinking-ide/src/models/source.ts)、[src/services/chatAdapter.ts](/Users/qyx/Desktop/project/thinking-ide/src/services/chatAdapter.ts) 和 [src/services/sourceLocator.ts](/Users/qyx/Desktop/project/thinking-ide/src/services/sourceLocator.ts) 已经支持 durable `heading` source anchor，并在 live assistant DOM 可用时先定位同名 H1，但没有 Markdown AST，也没有更稳定的段落级 anchor | P0 | 解析对象比最初更接近需求，但仍未达到可精确定位回答段落的 acceptance |
